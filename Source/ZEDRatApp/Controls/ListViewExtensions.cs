...
namespace ZEDRatApp.Controls
{
	public static class ListViewExtensions
	{
		...
		{
			int num = ListViewExtensions.SendMessage(lvw.Handle, 4151u, 0, 0);
			ListViewExtensions.SendMessage(lvw.Handle, 4150u, 0, (!show) ? (num & -3) : (num | 2));
		}
		...
		public static void AddIconToSubitem(this ListView lvw, int row, int col, int icon_num)
		{
			...
			ListViewExtensions.SendMessage(lvw.Handle, 4102u, 0, ref item_info);
		}
	}
}
