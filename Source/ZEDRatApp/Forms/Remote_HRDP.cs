...
namespace ZEDRatApp.Forms
{
	public class Remote_HRDP : Form
	{
		...
		private SiticoneRoundedTextBox txtToken;
		...
		{
			string text = ((TextBox)this.txtToken).Text;
		...
		private void InitializeComponent()
		{
			...
			this.txtToken = new SiticoneRoundedTextBox();
			...
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Location = new System.Drawing.Point(289, 21);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Name = "siticoneLabel12";
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Size = new System.Drawing.Size(111, 23);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).TabIndex = 83;
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Text = "Remote HRDP";
			...
			((SiticoneTextBox)this.txtToken).BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((System.Windows.Forms.Control)(object)this.txtToken).Cursor = System.Windows.Forms.Cursors.IBeam;
			((TextBox)this.txtToken).DefaultText = "";
			((SiticoneTextBox)this.txtToken).DisabledState.BorderColor = System.Drawing.Color.FromArgb(208, 208, 208);
			((SiticoneTextBox)this.txtToken).DisabledState.FillColor = System.Drawing.Color.FromArgb(226, 226, 226);
			((SiticoneTextBox)this.txtToken).DisabledState.ForeColor = System.Drawing.Color.FromArgb(138, 138, 138);
			((SiticoneTextBox)this.txtToken).DisabledState.Parent = (TextBox)(object)this.txtToken;
			((SiticoneTextBox)this.txtToken).DisabledState.PlaceholderForeColor = System.Drawing.Color.FromArgb(138, 138, 138);
			((SiticoneTextBox)this.txtToken).FillColor = System.Drawing.Color.FromArgb(18, 15, 24);
			((SiticoneTextBox)this.txtToken).FocusedState.BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneTextBox)this.txtToken).FocusedState.Parent = (TextBox)(object)this.txtToken;
			((SiticoneTextBox)this.txtToken).HoveredState.BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneTextBox)this.txtToken).HoveredState.Parent = (TextBox)(object)this.txtToken;
			...
			((TextBox)this.txtToken).PasswordChar = '\0';
			((SiticoneTextBox)this.txtToken).PlaceholderText = "";
			((TextBox)this.txtToken).SelectedText = "";
			((SiticoneTextBox)this.txtToken).ShadowDecoration.Parent = (System.Windows.Forms.Control)(object)this.txtToken;
			...
			((SiticoneButton)this.btnTokenExec).BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnTokenExec).BorderThickness = 1;
			((SiticoneButton)this.btnTokenExec).CheckedState.Parent = (CustomButtonBase)(object)this.btnTokenExec;
			((SiticoneButton)this.btnTokenExec).CustomBorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnTokenExec).CustomImages.Parent = (CustomButtonBase)(object)this.btnTokenExec;
			((SiticoneButton)this.btnTokenExec).FillColor = System.Drawing.Color.FromArgb(9, 8, 13);
			...
			((SiticoneButton)this.btnTokenExec).HoveredState.Parent = (CustomButtonBase)(object)this.btnTokenExec;
			...
			((SiticoneButton)this.btnTokenExec).ShadowDecoration.Parent = (System.Windows.Forms.Control)(object)this.btnTokenExec;
