...
namespace ZEDRatApp.Forms
{
	public class Remote_SetClipboard : Form
	{
		...
		private void InitializeComponent()
		{
			...
			((SiticoneButton)this.btnSetClipboard).BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnSetClipboard).BorderThickness = 1;
			((SiticoneButton)this.btnSetClipboard).CheckedState.Parent = (CustomButtonBase)(object)this.btnSetClipboard;
			((SiticoneButton)this.btnSetClipboard).CustomBorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnSetClipboard).CustomBorderThickness = new System.Windows.Forms.Padding(1, 0, 0, 0);
			((SiticoneButton)this.btnSetClipboard).CustomImages.Parent = (CustomButtonBase)(object)this.btnSetClipboard;
			((SiticoneButton)this.btnSetClipboard).FillColor = System.Drawing.Color.FromArgb(18, 15, 24);
			...
			((SiticoneButton)this.btnSetClipboard).HoveredState.Parent = (CustomButtonBase)(object)this.btnSetClipboard;
			...
			((SiticoneButton)this.btnSetClipboard).ShadowDecoration.Parent = (System.Windows.Forms.Control)(object)this.btnSetClipboard;
			...
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Location = new System.Drawing.Point(249, 19);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Name = "siticoneLabel12";
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Size = new System.Drawing.Size(110, 23);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).TabIndex = 56;
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Text = "Set Clipboard";
