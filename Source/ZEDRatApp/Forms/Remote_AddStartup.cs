...
namespace ZEDRatApp.Forms
{
	public class Remote_AddStartup : Form
	{
		...
		public void UpdateRemoteStartup_Form(string DateType, object ob)
		{
			try
			{
				...
				else if (DateType == "ProcessPath")
				{
					base.Invoke((MethodInvoker)delegate
					{
						((TextBox)this.txtPath).Text = (string)ob;
					});
				}
			}
			catch (Exception)
		...
		private void InitializeComponent()
		{
			...
			((SiticoneButton)this.btnCancel).BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnCancel).BorderThickness = 1;
			((SiticoneButton)this.btnCancel).CheckedState.Parent = (CustomButtonBase)(object)this.btnCancel;
			((SiticoneButton)this.btnCancel).CustomBorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnCancel).CustomBorderThickness = new System.Windows.Forms.Padding(1, 0, 0, 0);
			((SiticoneButton)this.btnCancel).CustomImages.Parent = (CustomButtonBase)(object)this.btnCancel;
			((SiticoneButton)this.btnCancel).FillColor = System.Drawing.Color.FromArgb(18, 15, 24);
			...
			((SiticoneButton)this.btnCancel).HoveredState.Parent = (CustomButtonBase)(object)this.btnCancel;
			...
			((SiticoneButton)this.btnCancel).ShadowDecoration.Parent = (System.Windows.Forms.Control)(object)this.btnCancel;
			...
			((SiticoneButton)this.btnAdd).BorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnAdd).BorderThickness = 1;
			((SiticoneButton)this.btnAdd).CheckedState.Parent = (CustomButtonBase)(object)this.btnAdd;
			((SiticoneButton)this.btnAdd).CustomBorderColor = System.Drawing.Color.FromArgb(226, 28, 71);
			((SiticoneButton)this.btnAdd).CustomBorderThickness = new System.Windows.Forms.Padding(1, 0, 0, 0);
			((SiticoneButton)this.btnAdd).CustomImages.Parent = (CustomButtonBase)(object)this.btnAdd;
			((SiticoneButton)this.btnAdd).FillColor = System.Drawing.Color.FromArgb(18, 15, 24);
			...
			((SiticoneButton)this.btnAdd).HoveredState.Parent = (CustomButtonBase)(object)this.btnAdd;
			...
			((SiticoneButton)this.btnAdd).ShadowDecoration.Parent = (System.Windows.Forms.Control)(object)this.btnAdd;
			...
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Location = new System.Drawing.Point(256, 21);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Name = "siticoneLabel12";
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Size = new System.Drawing.Size(140, 23);
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).TabIndex = 92;
			((System.Windows.Forms.Control)(object)this.siticoneLabel12).Text = "StartUp Manager";
