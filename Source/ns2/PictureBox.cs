	...
	public class PictureBox : System.Windows.Forms.PictureBox, IControl
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			if (this.int_0 > 0)
			{
				...
				using GraphicsPath path = Class6.smethod_12(Class6.smethod_11(base.ClientRectangle), checked(this.int_0 * 2));
				e.Graphics.FillPath(brush, path);
				return;
			}
			if (base.Image == null && this.color_0 != Color.Empty)
			{
				e.Graphics.FillRectangle(new SolidBrush(this.color_0), base.ClientRectangle);
			}
			base.OnPaint(e);
		}
	}
