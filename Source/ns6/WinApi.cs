...
namespace ns6
{
	...
	public static class WinApi
	{
		...
		[DllImport("user32.dll")]
		public static extern bool SetWindowPos(IntPtr hWnd, IntPtr hWndInsertAfter, int int_0, int int_1, int int_2, int int_3, uint uFlags);
		...
		public static extern IntPtr SHAppBarMessage(GEnum0 dwMessage, [In] ref APPBARDATA pData);
		...
		[DllImport("user32", CharSet = CharSet.Auto)]
		public static extern bool MoveWindow(IntPtr hwnd, int int_0, int int_1, int nWidth, int nHeight, bool bRepaint);
